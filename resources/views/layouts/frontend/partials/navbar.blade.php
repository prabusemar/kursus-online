<div class="w-full bg-[#bd562d] p-3 border-b border-dashed border-[#fffcf2]">
            ...
            <ul class="flex items-center justify-center gap-5">
                <li>
                    <a href="/" class="flex items-center text-lg text-white font-semibold">
                        <img src="{{ asset('PPLG.png') }}" alt="SmartLearn Logo" class="w-8 h-8 mr-2">
                        SmartLearn
                    </a>
                </li>
                ...
                <li class="hidden lg:flex">
                    <div class="relative" x-data="{ isOpen: false }">
                        ...
                        <ul x-cloak x-show="isOpen" @click.away="isOpen = false"
                            class="absolute font-normal bg-[#252422] shadow overflow-hidden rounded-lg w-48 border border-slate-700 mt-2 py-1 left-0 z-20">
            ...
            <div class="hidden md:flex items-center gap-2 text-white">
                ...
                @auth
                    ...
                    <div class="relative" x-data="{ isOpen: false }">
                        ...
                        <ul x-cloak x-show="isOpen" @click.away="isOpen = false"
                            class="absolute font-normal bg-[#252422] shadow overflow-hidden rounded-lg w-48 border border-slate-700 mt-2 py-1 right-0 z-20">
                            <li>
                                @role('admin')
