...
(6, '2022_10_05_063749_create_categories_table', 1),
(7, '2022_10_05_082952_create_courses_table', 1),
(8, '2022_10_06_123302_create_videos_table', 1),
(9, '2022_10_08_105241_create_transactions_table', 1),
(10, '2022_10_08_105502_create_transaction_details_table', 1),
(11, '2022_10_13_064659_create_carts_table', 1),
(12, '2022_10_15_181614_create_permission_tables', 1),
(13, '2022_10_17_073712_create_showcases_table', 1),
(14, '2022_10_17_191555_create_reviews_table', 1),
(15, '2022_10_20_214800_create_notifications_table', 1);
...
('6ab80c26-3fba-40cb-862a-2301587c1fff', 'App\\Notifications\\NewMember', 'App\\Models\\User', 1, '{\"message\":\"New Member\",\"data\":\"Muhammad Zahwan Sidqi\"}', NULL, '2024-10-14 05:09:40', '2024-10-14 05:09:40');
...
(1, 'admin', 'web', '2024-10-14 04:26:32', '2024-10-14 04:26:32'),
(2, 'member', 'web', '2024-10-14 04:26:32', '2024-10-14 04:26:32'),
(3, 'author', 'web', '2024-10-14 04:26:32', '2024-10-14 04:26:32');
...
ALTER TABLE `showcases`
  ADD PRIMARY KEY (`id`),
  ADD KEY `showcases_user_id_foreign` (`user_id`),
  ADD KEY `showcases_course_id_foreign` (`course_id`);
...
--
ALTER TABLE `showcases`
  ADD CONSTRAINT `showcases_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `showcases_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
